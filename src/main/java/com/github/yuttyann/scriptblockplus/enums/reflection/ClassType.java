...
public enum ClassType {
    ...
    public static Class<?>[] getPrimitive(@Nullable Class<?>[] classes) {
        ...
        return StreamUtils.toArray(classes, c -> getPrimitive(c), new Class<?>[classes.length]);
    }
    ...
    public static Class<?>[] getReference(@Nullable Class<?>[] classes) {
        ...
        return StreamUtils.toArray(classes, c -> getReference(c), new Class<?>[classes.length]);
    }
    ...
    public static Class<?>[] getPrimitive(@Nullable Object[] objects) {
        ...
        Class<?>[] classes = CLASS_CACHE.get(hash);
        if (classes == null) {
            classes = StreamUtils.toArray(objects, o -> getPrimitive(o.getClass()), new Class<?>[objects.length]);
    ...
    public static Class<?>[] getReference(@Nullable Object[] objects) {
        ...
        Class<?>[] classes = CLASS_CACHE.get(hash);
        if (classes == null) {
            classes = StreamUtils.toArray(objects, o -> getReference(o.getClass()), new Class<?>[objects.length]);
            CLASS_CACHE.put(hash, classes);
        }
        return classes;
    }
