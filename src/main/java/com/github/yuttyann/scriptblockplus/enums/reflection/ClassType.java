...
public enum ClassType {
    ...
    public static Class<?>[] getPrimitive(@Nullable Object[] objects) {
        ...
        return StreamUtils.toArray(objects, o -> getPrimitive(o.getClass()), new Class<?>[objects.length]);
    }
    ...
    public static Class<?>[] getReference(@Nullable Object[] objects) {
        ...
        return StreamUtils.toArray(objects, o -> getReference(o.getClass()), new Class<?>[objects.length]);
    }
}